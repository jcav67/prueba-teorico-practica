...
def conteo_de_dias(inicio, final) -> list:
  """
    ...
    return
      semana-> list
  """
  dia_inicial  = datetime.datetime.strptime(inicio,'%d/%m/%Y %H:%M:%S %z')
  print(dia_inicial)
  dia_final    = datetime.datetime.strptime(final,'%d/%m/%Y %H:%M:%S %z')
  print(dia_final)
  semana        = {}
...
fecha_1 ='10/10/2022 10:22:20 -1000'
fecha_2 ='30/05/2023 19:42:20 +0930'
print(conteo_de_dias(fecha_1, fecha_2))
print("horas laboradas",horas_laboradas(fecha_1, fecha_2))
print(diferencia_horas(fecha_1, fecha_2))
